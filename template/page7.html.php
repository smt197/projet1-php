		...
		<table class="table">
			...
			<tbody>
				<tr>
					...
					<td>Mbow</td>
					<td>Baye Saer</td>
					<td>mbowbayesaer44@gmail.com</td>
					<td>M</td>
					<td>777220908</td>
					<td>
						
						<i class="fa-regular fa-square"></i>					</td>
				</tr>
				<tr>
					<td><i style="padding: 16%;border-radius: 25%; background-color: rgb(119, 236, 236);" class="fa-solid fa-user"></i></td>
					<td>Wade</td>
					<td>Fanta Ndao</td>
					<td>fantatine18@gmail.com</td>
					<td>F</td>
					<td>785286330</td>
					<td>
				...
				<tr>
					<td><i style="padding: 16%;border-radius: 25%; background-color: rgb(119, 236, 236);" class="fa-solid fa-user"></i></td>
					<td style="color: red;">Seck</td>
					<td td style="color: red;">Fanta Ndao</td>
					<td>fantatine18@gmail.com</td>
					<td>F</td>
					<td>785286330</td>
					<td>
					...
					<div class="contentrer">
						...
						<form action="index.php" method="GET">
							...
							<div class="texte">
								...
								<input type="text" name="image" placeholder="joindre l'image" >
							</div>
							<div class="texte">
							...
							<div class="diver2">
								...
								<input type="tel" name="telephone" placeholder="Entrer le telephone" >
							</div>
							<div class="texte3">
							...
							<div class="boutton">
								<button type="submit" class="vert" name="envoyer" value="envoyer">Envoyer</button>
							</div>
    					</form>
						<!-- <div class="texte">
							<div class="text1">Nom </div>
						...
						<div class="boutton">
							<a href="#demo1_suiv"><div class="vert">Suivant</div></a>
						</div> -->
					</div>
				</section>
